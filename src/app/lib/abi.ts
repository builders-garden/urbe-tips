export const azuroBetAbi = [
  ...
  },
  {
    ...
    name: "addLiquidity",
    outputs: [{ internalType: "uint48", name: "depositId", type: "uint48" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "address", name: "newAffiliate", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "affiliate_", type: "address" },
